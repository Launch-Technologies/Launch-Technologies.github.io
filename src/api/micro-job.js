...
class MicroJobService extends CrudApi {
  ...
  async postMicroJobSkill(params) {
    let result = await this.post(`/micro-job-skills`, params);
    return result;
  }

  async postMicroJobFiles(params) {
    let result = await this.post(`/micro-job-files`, params);
    return result;
  }
